...
/*
The data type Point& p is a reference type, backed by a hidden pointer.
This brings C++ closer to the syntax of other languages.
It gets you reference type behavior, without the pointer syntax.
It is cleaner and easier to read (and there are some safety benefits as well).
*/
